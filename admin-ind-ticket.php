...
?>
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col-md-1">
                <a href="admin-main.php" type="button" class="btn btn-block p-0"> <i
        ...
        <div class="row mb-5">
            ...
            <div class="col-md-12 my-5">
                ...
                <div class="chatbox mx-auto container">
                    ...
                    <form action="controller/admin-ticket-page/admin-message-post.php" method="post"
                          onSubmit='return false;' autocomplete="off"
                          class="row" id="chatForm">
                        ...
                        <div class="col-md-3">
                            ...
                            <button type="button" id="close_ticket_admin" value="Post"
